...
def send_chek(link_file, name_object, number):
    file_url = (f'Здравствуйте, {name_object}! Напоминаю Вам об оплате услуг rkeeper.\n'
                ...
                f'Если вы получили это сообщение ошибочно, просьба написать на почту mva@solardsoft.ru с указанием счёта и номера телефона.  номер телефона: {name_object}, *сслыка на счета:* {link_file}\n')
